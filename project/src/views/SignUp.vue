    ...
    >
      <div class="item-group-center" style="margin-top: 30px">
        <v-text-field
          ...
          color="#000"
        ></v-text-field>
        <p style="margin-top: 7px; margin-left: 5px; margin-right: 50px">
          :رمز عبور
        </p>
        <v-text-field
      ...
      <div class="item-group-center" style="margin-top: 20px">
        <v-text-field
          ...
          color="#000"
        ></v-text-field>
        <p style="margin-top: 7px; margin-left: 5px; margin-right: 20px">
          :نام خانوادگی
        </p>
        <v-text-field
      ...
      <div class="item-group-center" style="margin-top: 20px">
        ...
        <v-text-field
          v-model="formData.nationalNumber"
          outlined
          class="shrink"
          style="width: 200px"
          :background-color="textFieldBackgroundColor"
      ...
      <div class="item-group-center" style="margin-top: 20px">
        <v-text-field
          ...
          outlined
          class="shrink"
          style="width: 510px; margin-left: 15px"
          :background-color="textFieldBackgroundColor"
          dense
          color="#000"
        ></v-text-field>
...
export default {
  ...
  methods: {
    signup() {
      ...
      } else this.errorMessage = ".تمامی فیلد ها باید پر شوند";
    },
    mainPage() {
